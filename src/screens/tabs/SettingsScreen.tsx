  ...
  return (
    ...
    <SafeAreaView className="flex-1">
      ...
      <View className="flex-row items-center justify-center px-5 pt-4 pb-2">
        <Text style={{ fontSize: 20, fontWeight: '700', color: colors.textPrimary }}>Your profile</Text>
      </View>
      ...
      >
        ...
        <View className="mt-6 mb-6">
          <Pressable className="flex-row items-center" onPress={handleEditName}>
            <View
              className="w-20 h-20 rounded-full items-center justify-center"
              style={{ backgroundColor: colors.elevatedBg }}
            >
              <Ionicons name="person" size={36} color={colors.textAccent} />
            </View>
            <Ionicons
